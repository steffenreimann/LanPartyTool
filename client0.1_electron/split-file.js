 ...
 * @returns {Promise}
 */
SplitFile.prototype.splitFile = function(file, parts, outpath) {
    var self = this;
    ...
    return Promise.promisify(fs.stat)(file).then(function (stat) {
        ...
        return self.__splitFile(file, partInfo, outpath);
    });
};
 ...
 * @returns {Promise}
 */
SplitFile.prototype.splitFileBySize = function(file, maxSize, outpath) {
    var self = this;
 ...
 * @returns {Promise}
 */
SplitFile.prototype.__splitFile = function (file, partInfo, outpath) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if(outpath == undefined){
               var partName = file + '.sf-part' + partNumber;
                        ...
                        var partName = outpath + '.sf-part' + partNumber;
                        }
            
            
            console.log("Split-File Module " + partNumber);
            console.log("Split-File Module " + outpath);
